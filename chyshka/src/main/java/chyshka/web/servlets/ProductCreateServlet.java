...
import chyshka.models.service.ProductServiceModel;
...
public class ProductCreateServlet extends HttpServlet {
    ...
    private final static String CREATE_PRODUCT_HTML_FILE_PATH = "D:\\Repository\\Java-Web-Development-Basics\\chyshka\\src\\main\\resources\\views\\create-product.html";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        productServiceModel.setType(req.getParameter("select"));
    ...
    private String formatTypeOptions(){
        ...
        Arrays.stream(Type.values())
                .forEach((type) -> options.append(String.format("<option value=\"%s\">%s</option>",type.name(),type.name()))
